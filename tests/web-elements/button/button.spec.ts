...
let listButton = ['Div button','Origin button','Input button','Default','Primarys','Dashed','Text','Link','Icon button'];
...
function clickButtonByLabel(label : string, page : Page){
    ...
    page.locator(`${divButtonXpath} | ${inputButtonXpath} | ${buttonXpath}`).click();
} 